			...
			<div class="bg-white rounded mt-4 shadow-lg py-6">
				<div class="px-8">
					<div class="flex items-end">
						...
						<span class="text-sm ml-auto font-semibold">$00</span>
						<span class="text-xs text-gray-500 mb-px">/00</span>
					</div>
					<span class="text-xs text-gray-500 mt-2"> 20%</span>
				</div>
				<div class="px-8 mt-4">
				...
				<div class="flex items-center px-8 mt-8">
					...
					<label class="text-xs text-gray-500 ml-2" for="termsConditions">Eu concordo com os Termos e Condições.</label>
				</div>
				<div class="flex flex-col px-8 pt-4">
					<button class="flex items-center justify-center bg-blue-600 text-sm font-medium w-full h-10 rounded text-blue-50 hover:bg-blue-700">Concluir reserva</button>
					<button class="text-xs text-blue-500 mt-3 underline">Tenho um cupom?</button>
				</div>
			</div>
		</div>
	</div>
