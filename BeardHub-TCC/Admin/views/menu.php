                    ...
                    <ul class="list-reset flex flex-row md:flex-col pt-3 md:py-3 px-1 md:px-2 text-center md:text-left">
                        <li class="mr-3 flex-1">
                            <a href="painelAdmin.php?r=today" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-purple-500">
                                <i class="fas fa-tasks pr-0 md:pr-3"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-blue-400 md:text-gray-200 block md:inline-block">Agendamentos</span>
                            </a>
                        </li>
                        <li class="mr-3 flex-1">
                            ...
                            <i class="fa-solid fa-store pr-0 md:pr-3"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-white- md:text-white block md:inline-block">Estabelecimento</span>
                            </a>
                        </li>
                        <li class="mr-3 flex-1">
                            <a href="index.html" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-blue-600">
                                <i class="fas fa-chart-area pr-0 md:pr-3 text-blue-600"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-blue-600 md:text-blue-600 block md:inline-block">Analytics</span>
                            </a>
                        </li>
                        <li class="mr-3 flex-1">
