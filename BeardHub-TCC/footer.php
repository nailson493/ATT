<footer class="p-4 bg-dark:bg-gray-900 sm:p-6 dark:bg-gray-900">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="https://flowbite.com/" class="flex items-center">
                    <img src="img/logo.png" class="mr-3 h-8" alt="FlowBite Logo" />
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">BeardHub</span>
                </a>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    <h2 class="mb-6 text-sm  text-white-900 uppercase dark:text-white">Resources</h2>
                    <ul class="text-white-900 dark:text-white">
                        <li class="mb-4">
                ...
                <div>
                    <h2 class="mb-6 text-sm  text-white uppercase dark:text-white">Follow us</h2>
                    <ul class="text-white-900 dark:text-white">
                        <li class="mb-4">
                ...
                <div>
                    <h2 class="mb-6 text-sm  text-white uppercase dark:text-whitee">Legal</h2>
                    <ul class="text-white-900 dark:text-white">
                        <li class="mb-4">
